...
export const Aviso = () => {
  return (
    <>
      <section className='content tyc-section'>
        <div className='title-section empleados-title'>
          <h1>AVISO DE PRIVACIDAD</h1>
        </div>

        <p>A los Usuarios (como se definen posteriormente), les informamos que el siguiente Aviso de Privacidad, les es aplicable por el simple uso o acceso a cualquiera de las páginas, aplicaciones web y móviles, softwares y, aplicaciones en general, que integran el Portal de www.inyob.com (en adelante y, conjunta e indistintamente, el "Portal"), por lo que entenderemos que lo acepta y acuerda en obligarse en su cumplimiento. En caso de que no esté de acuerdo con el Aviso de Privacidad  a su disposición, deberá abstenerse de acceder o utilizar el Portal.</p>
        ...
        <p><strong>RESPONSABLE DEL TRATAMIENTO DE SUS DATOS PERSONALES.</strong> Para INYOB S.A.P.I. DE C.V. (en adelante la “Empresa”) la seguridad de los Usuarios es nuestra prioridad, por lo que protegemos sus datos personales mediante el uso, aplicación y mantenimiento de altas medidas de seguridad técnicas, físicas y administrativas.</p>
        ...
        <p><strong>DOMICILIO DEL RESPONSABLE.</strong> Para efectos del presente aviso de privacidad, la Empresa señala, individualmente, como su domicilio, el ubicado en Zeta 202, Industrial Delta, León, Guanajuato, C. P. 37545</p>
        ...
        <p>1.	Se recopilan de manera enunciativa mas no limitativa datos como el  nombre completo, correo electrónico, fecha de nacimiento, domicilio, género, escolaridad, estado civil, experiencia laboral, documentos de identidad personal, entre otros.</p>
        ...
        <p>1.	La finalidad de recopilar dichos datos es generar un perfil para el candidato, el cual puede ser compartido con las empresas que publican sus vacantes en la plataforma, con el objetivo de promover sus perfiles para cubrir las vacantes mencionadas.</p>

        <p>2.	Para integrar expedientes, bases de datos y sistemas necesarios para llevar a cabo las operaciones y servicios correspondientes; (ii) Para reclamar la entrega de premios y/o promociones; (iii) Para llevar a cabo análisis internos;</p>

        <p>3.	De manera adicional, se podrán utilizar sus datos personales para las siguientes finalidades secundarias: (i) Mercadotecnia, publicidad y prospección comercial; (ii) Ofrecerle, en su caso, otros productos y servicios propios de la Empresa o de cualquiera de sus afiliadas, subsidiarias, sociedades controladoras, asociadas, comisionistas o sociedades; (iii) Remitirle promociones de otros bienes, servicios y/o productos; (iv) Para realizar análisis estadísticos, de generación de modelos de información y/o perfiles de comportamiento actual y predictivo y, (v) Para participar en encuestas, sorteos y promociones.</p>

        <p><strong>OPCIONES Y MEDIOS PARA LIMITAR EL USO O DIVULGACIÓN DE LOS DATOS.</strong> La Empresa tiene implementadas medidas de seguridad administrativas, técnicas y físicas para proteger sus datos personales, mismas que igualmente exigimos sean cumplidas por los proveedores de servicios que contratamos. Usted podrá limitar el uso o divulgación de sus datos personales enviando un correo electrónico a contacto@inyob.com indicándonos en el cuerpo del correo su nombre completo y que dato desea que no sea divulgado, de proceder su solicitud, se le registrará en el listado de exclusión.</p>

        <p><strong>MEDIOS PARA EJERCER LOS DERECHOS DE ACCESO, RECTIFICACIÓN, CANCELACIÓN U OPOSICIÓN (DERECHOS ARCO). </strong>Puede enviar un correo electrónico a contacto@inyob.com, en cualquier momento, para ejercer sus Derechos de Acceso, Rectificación, Cancelación u Oposición (“Derechos ARCO”). Para ejercer los Derechos ARCO, usted (o su representante legal), deberá presentar la solicitud, identificándose con la siguiente documentación:</p>
        ...
        <p><strong>TRANSFERENCIA DE DATOS PERSONALES.</strong> La Empresa podrá divulgar sus datos personales a aquellos terceros que, en virtud de los servicios y productos ofrecidos, necesiten conocerlos para cumplir cabalmente con los mismos.</p>
        ...
        <p><strong>MODIFICACIONES AL AVISO DE PRIVACIDAD.</strong> El presente aviso de privacidad puede sufrir modificaciones, cambios o actualizaciones derivadas, entre otras cosas, por nuevos requerimientos legales; necesidades propias de la Empresa, por los productos o servicios que ofrecemos; por nuestras prácticas de privacidad; por cambios en nuestro modelo de negocio, o por otras causas.</p>
