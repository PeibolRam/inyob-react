import EmpleadosHero from '../assets/images/Empleados-hero.png'
    ...
    <>
      ...
      <section className='content'>
        <div className='title-section empleados-title'>
          <h3>¿Buscas un trabajo que verdaderamente cumpla con tus expectativas y donde puedes empezar a trabajar en días y no semanas?</h3>
        </div>
      ...
      <section className='content'>
        <div className='empleados-bottom empleados-left'>
          <p>Descubre como juntos podemos elevar tu estrategia de reclutamiento al siguiente</p>
          <ul>
            <li>
        ...
        <a href="https://wa.link/241l8t" className='btn'>¡Hablemos!</a>
      </section>
    </>
  )
}
